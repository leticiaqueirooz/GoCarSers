...
public final class CarReturnGrpc {
  ...
  public static final String SERVICE_NAME = "strings.CarReturn";
  ...
  private static volatile io.grpc.MethodDescriptor<carreturn.CarFeedbackRequest,
      carreturn.CarFeedbackResponse> getCarFeedbackMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CarFeedback",
      requestType = carreturn.CarFeedbackRequest.class,
      responseType = carreturn.CarFeedbackResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<carreturn.CarFeedbackRequest,
      carreturn.CarFeedbackResponse> getCarFeedbackMethod() {
    io.grpc.MethodDescriptor<carreturn.CarFeedbackRequest, carreturn.CarFeedbackResponse> getCarFeedbackMethod;
    if ((getCarFeedbackMethod = CarReturnGrpc.getCarFeedbackMethod) == null) {
      synchronized (CarReturnGrpc.class) {
        if ((getCarFeedbackMethod = CarReturnGrpc.getCarFeedbackMethod) == null) {
          CarReturnGrpc.getCarFeedbackMethod = getCarFeedbackMethod = 
              io.grpc.MethodDescriptor.<carreturn.CarFeedbackRequest, carreturn.CarFeedbackResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "strings.CarReturn", "CarFeedback"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  carreturn.CarFeedbackRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  carreturn.CarFeedbackResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new CarReturnMethodDescriptorSupplier("CarFeedback"))
                  .build();
          }
        }
     }
     return getCarFeedbackMethod;
  }
  ...
  public static abstract class CarReturnImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void carFeedback(carreturn.CarFeedbackRequest request,
        io.grpc.stub.StreamObserver<carreturn.CarFeedbackResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getCarFeedbackMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getCarFeedbackMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                carreturn.CarFeedbackRequest,
                carreturn.CarFeedbackResponse>(
                  this, METHODID_CAR_FEEDBACK)))
          .build();
    }
  }
  ...
  public static final class CarReturnStub extends io.grpc.stub.AbstractStub<CarReturnStub> {
    ...
    public void carFeedback(carreturn.CarFeedbackRequest request,
        io.grpc.stub.StreamObserver<carreturn.CarFeedbackResponse> responseObserver) {
      asyncServerStreamingCall(
          getChannel().newCall(getCarFeedbackMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class CarReturnBlockingStub extends io.grpc.stub.AbstractStub<CarReturnBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<carreturn.CarFeedbackResponse> carFeedback(
        carreturn.CarFeedbackRequest request) {
      return blockingServerStreamingCall(
          getChannel(), getCarFeedbackMethod(), getCallOptions(), request);
    }
  }
  ...
  private static final int METHODID_CAR_FEEDBACK = 0;
  private static final int METHODID_CAR_RETURN = 1;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CAR_FEEDBACK:
          serviceImpl.carFeedback((carreturn.CarFeedbackRequest) request,
              (io.grpc.stub.StreamObserver<carreturn.CarFeedbackResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (CarReturnGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getCarFeedbackMethod())
              .build();
        }
      }
    }
